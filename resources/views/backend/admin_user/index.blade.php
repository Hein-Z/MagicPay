...
@endsection
@section('dashboard-title', 'Admin User Management')
@section('card-header', 'Admin Users')
@section('content')
    <a class="btn-primary btn my-2 mx-3 text-white" href="/admin/admin-users/create"><i
    ...
    <script>
        $(document).ready(function() {
            var table = $('#data').DataTable({
                processing: true,
                serverSide: true,
                ajax: "/admin/admin-users/database/ssd",
                columns: [{
                        data: 'select',
                        name: 'select'
                    },
            ...
            $('#delete-multiple-btn').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '/admin/admin-users/delete-selected',
                            type: 'DELETE',
